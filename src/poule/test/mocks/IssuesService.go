...
func (_m *IssuesService) AddAssignees(owner string, repo string, number int, assignees []string) (*github.Issue, *github.Response, error) {
	ret := _m.Called(owner, repo, number, assignees)

	var r0 *github.Issue
	if rf, ok := ret.Get(0).(func(string, string, int, []string) *github.Issue); ok {
		r0 = rf(owner, repo, number, assignees)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, string, int, []string) *github.Response); ok {
		r1 = rf(owner, repo, number, assignees)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(string, string, int, []string) error); ok {
		r2 = rf(owner, repo, number, assignees)
	} else {
		r2 = ret.Error(2)
	}
...
var _ gh.IssuesService = (*IssuesService)(nil)
